...
// API호출 부분이 기존의 리액트와 동일함 클라이언트에서 렌더링이 됨
	...
	return (
		<>
			...
			<main>
				<h1>Search News</h1>
				<Alert>
					This is page uses <strong>client-side data fetching</strong> to show fresh data for every search. Requests are
					handled by our backend via <strong>API routes</strong>.
				</Alert>
